...
const ModelSelect: React.FC = () => {
  ...
  const addCheckModelId = (model: Model) => {
    setCheckedModelIdList([...checkedModelIdList, model.id]);
  };
  ...
  return (
    <>
      <div className="flex justify-between w-full h-12 pl-4 pr-4" role="toolbar" aria-label={t(($) => $.common.a11y.modelToolbar)}>
