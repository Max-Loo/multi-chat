...
export const NoProvidersAvailable: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-background" data-testid="no-providers-container">
      <div className="flex max-w-md flex-col items-center gap-6 text-center p-6" data-testid="no-providers-content">
        <AlertCircle className="h-16 w-16 text-destructive" data-testid="no-providers-icon" />
