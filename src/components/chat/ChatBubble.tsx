...
const ChatBubbleInner: React.FC<ChatBubbleProps> = ({
  ...
  switch (role) {
    ...
    case ChatRoleEnum.USER: {
      return (
        <div className="flex justify-end w-full mt-3 mr-2" data-testid="user-message" aria-label={t($ => $.common.a11y.userMessage)}>
    ...
    case ChatRoleEnum.ASSISTANT: {
      return (
        <div className="flex justify-start w-full mt-3 ml-2" data-testid="assistant-message" aria-label={t($ => $.common.a11y.assistantMessage)}>
