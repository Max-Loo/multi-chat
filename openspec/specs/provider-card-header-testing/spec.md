# ProviderCardHeader Testing

## Capability: provider-card-header-testing

Tests for the `ProviderCardHeader` component, verifying rendering of provider name, logo, status badges, and expand/collapse icon direction.
