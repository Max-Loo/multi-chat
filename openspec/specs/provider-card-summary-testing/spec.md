# ProviderCardSummary Testing

## Capability: provider-card-summary-testing

Tests for the `ProviderCardSummary` component, verifying model count rendering and expand/collapse hint text visibility.
